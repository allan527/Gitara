  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        style={{ minHeight: '300px', minWidth: '100px', height: '100%', width: '100%', ...props.style }}
        {...props}
      >
        <ChartStyle id={chartId} config={config} />
        <RechartsPrimitive.ResponsiveContainer width="100%" height="100%" minHeight={300} minWidth={100}>
          {children}
